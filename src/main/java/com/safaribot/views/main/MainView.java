package com.safaribot.views.main;
...
import com.safaribot.views.main.MainView;
import com.safaribot.views.chat.ChatView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "safaribot", shortName = "safaribot",  enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "safaribot logo"));
        logoLayout.add(new H1("safaribot"));
